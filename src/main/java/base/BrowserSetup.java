...
public class BrowserSetup extends ReportUtils {
    ...
    public void globalConfig() throws Exception {
        ...
        useSeleniumGrid = "yes".equalsIgnoreCase(ConfigReader.prop.getProperty("useSeleniumGrid"));
    }
	...
	private void launchBrowser(String testName) throws Exception {
        ...
        if (useSeleniumGrid) {
            String seleniumGridUrl = System.getProperty("seleniumGridUrl", ConfigReader.prop.getProperty("seleniumGridUrl"));
        ...
        String url = ("QA".equalsIgnoreCase(environment))
                ? ConfigReader.prop1.getProperty("url")
